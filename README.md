...
| **frida-tea** | QA dirigido por riesgo (BMAD TEA adaptado): `tea-test-design` (plan P0-P3 + gate), `tea-framework` (setup auto-verificado), `tea-automate` (fan-out por target), `tea-test-review` (auditoría con severidades fijas y score 0-100) | [→](./docs/tools/frida-tea.md) · [guía](./docs/how-to-frida-tea.md) |
